...
Tu dostopate do seznama prevzemov dekontaminacijskih sredstev.
...
![Ikona za urejanje](../.gitbook/assets/Knjiga_ikona_pisalo.png)

![](../.gitbook/assets/Skladisce_dekontaminacijska_sredstva_uredi.PNG)

| Ime polja                      | Opis polja                                                             |
| ------------------------------ | ---------------------------------------------------------------------- |
| **Dekontaminacijsko sredstvo** | S pomočjo spustnega seznama izberite dekontaminacijsko sredstvo.       |
| **Datum prevzema**             | S pomočjo spustnega koledarja izberite datum prevzema.                 |
| **Količina**                   | Napišite količino.                                                     |
| **Cena za kg/kos/liter**       | Napišite ceno dekontaminacijskega sredstva za kg/kos/liter.            |
